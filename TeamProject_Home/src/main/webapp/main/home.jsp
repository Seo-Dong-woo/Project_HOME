...
<body>
	<div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <!-- Banner Section Start-->
		  <div class="container" style="Width:1500px;height:500px; margin-left: 480px;" >
		  <h2>동계 캠핑 안전수칙</h2>  
		  <div class="slide">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="${vo.poster }" class="img-fluid rounded-circle w-100">
                                </div>
                                <div class="col-6">
                                    ...
                                    <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary"> ${vo.difficulty }</a>
                                </div>
                            </div>
                        </div>
                    </div>
